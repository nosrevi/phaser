...
function preload() {
    ...
    game.rect = block.getBoundingClientRect();
    var block2 = document.getElementById('block2');
    game.rect2 = block2.getBoundingClientRect();
    var block3 = document.getElementById('block3');
    game.rect3 = block3.getBoundingClientRect();
...
function create() {
    ...
    game.paused = true;
    game.stage.backgroundColor = "#1D1F21";
    //  Enable p2 physics
    game.physics.startSystem(Phaser.Physics.P2JS);
    game.physics.p2.gravity.y = 1000;

    tetris1 = game.add.sprite(game.rect.left, game.rect.top, 'tetrisblock1');
    tetris2 = game.add.sprite(game.rect2.left, game.rect2.top, 'tetrisblock2');
    tetris3 = game.add.sprite(game.rect3.left, game.rect3.top, 'tetrisblock3');
